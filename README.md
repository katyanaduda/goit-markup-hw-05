...
`«A4»` Підключений нормалізатор стилів [`modern-normalize`](https://cdnjs.com/libraries/modern-normalize) (мініфікована версія).

`«A5»` Код написаний з дотриманням [`настанови`](https://codeguide.co/).

### Модальне вікно

`«B1»` Виконана розмітка і оформлення «бекдропа» (темного напівпрозорого фону) модального вікна. Він знаходиться в файлі `index.html` після футера.
...
`«C11»` Тег `<textarea>` має бути з фіксованим розміром, користувач не повинен мати можливості змінювати його.
